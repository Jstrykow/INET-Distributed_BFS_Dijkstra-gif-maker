...
def dijkstra(G: nx.Graph(), root_id):
    ...
    # def
    utils.draw_graph(G, blue_nodes=edges, green_nodes=know_nodes, orange_edges=orange_edges, green_edges=BFS,red_edges=red_edges, orange_nodes=orange_nodes)
    ...
    while len(orange_edges) != 0:
        orange_edges = []
        orange_nodes = []
        red_edges = []
        utils.draw_graph(G, blue_nodes=edges, green_nodes=know_nodes, orange_edges=[], green_edges=BFS, red_edges=red_edges, orange_nodes=[])
